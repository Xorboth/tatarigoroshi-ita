# Higurashi Cap. 3 Tatarigoroshi - Traduzione italiana

Il team di CTH Translations è lieto di fornirvi la traduzione italiana di Higurashi Capitolo 3 - Tatarigoroshi!<br/>
...
https://store.steampowered.com/app/472870/Higurashi_When_They_Cry_Hou__Ch3_Tatarigoroshi<br/>
https://www.gog.com/game/higurashi_when_they_cry_hou_ch3_tatarigoroshi<br/>
...
3. Fare partire il menu di configurazione per l'installazione della patch per Tatarigoroshi, mettendo la spunta sulla voce della traduzione italiana
...
2. Installare la patch inglese per Tatarigoroshi di 07th-Mod attraverso il 07th-Mod Installer:<br/>
https://github.com/07th-mod/python-patcher/releases/latest
...
https://github.com/Xorboth/tatarigoroshi-ita/releases/latest

4. Estrarre l'archivio appena scaricato

5. Aprire la cartella del gioco (su Steam ad esempio sta in "Steam\steamapps\common\Higurashi 03 - Tatarigoroshi")

6. Copiare la cartella della traduzione italiana "HigurashiEp03_Data" nella cartella del gioco, dove c'è un'altra cartella con lo stesso identico nome
...
8. Aprire la cartella "Higurashi 03 - Tatarigoroshi\HigurashiEp03_Data\StreamingAssets\CompiledUpdateScripts" ed eliminare tutti i file al suo interno
